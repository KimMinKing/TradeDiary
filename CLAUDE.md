...
## Phase 4 — 핵심 기능 ✅
- [x] 12. 매매 일기 CRUD (이유, 감정, 전략 태그)
- [x] 13. 전략 태그 관리 (기본 제공 + 사용자 정의)
- [x] 14. 통계 분석 API (승률, 시간대별, 종목별)
...
## Phase 6 — AI 서버 ✅
- [x] 21. Python FastAPI 서버 설정
- [x] 22. OpenAI GPT-4o mini 연동
- [x] 23. AI 분석 리포트 생성 (시간대별, 연속손실, 종목별)
- [x] 24. Spring Boot → Python 서버 연동
